                        ...
                        <div id="recordHeadingLine2" style="margin-top: 0px">
                            <h1><span style="font-size: 75%">
                                ...
                                <g:if test="${(record.processed?.location?.highResolution?:'false').toBoolean() && (grailsApplication.config?.hasHighResolution?.show?:'false').toBoolean()}">
                                    <i id="hasHighResolutionNavFlagTitle" class="glyphicon glyphicon-record my-tooltip" style="color:#AD841F;display:inline-block;margin-right:4px" title="<g:message code="show.record.hashighresolution" default="Record has higher resolution data available"/>"></i>
                                </g:if>
